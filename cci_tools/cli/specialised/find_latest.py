    ...
    for dirpath, dirnames, filenames in os.walk(root_path):
        ...
        for dirname in dirnames:
            ...
            if match:
                try:
                    ...
                    padded_dirname = dirname.ljust(
                        5, "0"
                    )  # Pads vX.X to be vX.XX. This ensures that v4.3 (i.e. v4.30) is interpretted as higher than v4.21
        ...
        if version_dirs:
            ...
            if latest_ver == latest_ver_num:
                ...
                raise ValueError(
                    f"Data version directory mismatch: {latest_ver} and {latest_ver_num} don't match!"
                )
